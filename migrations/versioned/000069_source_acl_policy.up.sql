-- Migration: 000069_source_acl_policy
-- Description: Store normalized source ACL snapshots and entries for source-backed knowledge.
DO $$ BEGIN RAISE NOTICE '[Migration 000069] Creating source ACL policy tables...'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000069] Source ACL policy tables ready'; END $$;

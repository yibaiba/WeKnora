-- Migration: 000079_wecom_identity_binding
...
DO $$ BEGIN RAISE NOTICE '[Migration 000079] Ensuring upstream 000064 principal model schema...'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000079] Ensuring upstream 000065 tenant_api_keys schema...'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000079] Creating WeCom identity binding tables...'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000079] WeCom identity binding tables ready'; END $$;

export default {
  ...
  uploadConfirm: {
    ...
    navChunkingSmart: 'Agent decides',
    processingModeLabel: 'Chunking mode',
    processingModeDescription: 'Smart analysis profiles each file and chooses its chunking parameters.',
    modeSmart: 'Smart analysis',
    modeKnowledgeBase: 'Knowledge base settings',
    smartDecisionHint: 'The Agent will choose the strategy, sizes, overlap, parent-child mode, and separators.',
    smartModelMissing: 'This knowledge base has no summary model. Smart analysis will fail explicitly; configure one or use knowledge base settings.',
    smartUrlsUseKb: 'URLs in this batch do not use smart analysis and will keep the knowledge base settings.',
    smartWebAccess: 'Allow web search and fetch',
    smartWebAccessDescription: 'When enabled, the Agent may send queries or selected source excerpts to configured external Web services.',
    smartMcpAccess: 'Allow read-only MCP tools',
    smartMcpAccessDescription: 'When enabled, the Agent may send queries or source excerpts to MCP tools that declare readOnlyHint=true; background processing will not wait for interactive authorization.',
    agentOwned: 'Agent decides',
    statusOn: 'On',
    statusOff: 'Off',
    notSet: 'Not set',
  ...
  knowledgeStages: {
    ...
    analysis: {
      ...
      applied: 'Applied',
      agentRunTitle: 'Agent run trace',
      rounds: 'Round {actual} / {max}',
      candidatesTitle: 'Candidate score comparison',
      ...
      tool: {
        ...
        list_knowledge_chunks: 'Read knowledge chunks',
        query_knowledge_graph: 'Query knowledge graph',
        get_document_info: 'Read document information',
        database_query: 'Read-only database query',
        data_analysis: 'Analyze data',
        data_schema: 'Read data schema',
        web_search: 'Search the web',
        web_fetch: 'Fetch web page',
        wiki_read_page: 'Read Wiki page',
        wiki_search: 'Search Wiki',
        wiki_read_source_doc: 'Read Wiki source',
        wiki_read_issue: 'Read Wiki issue'
      },
      documentKind: {
    ...
    errorCode: {
      ...
      INGESTION_MODEL_TOOL_CALLING_UNSUPPORTED_SUGGESTION: 'Use a summary model with native tool calling and retry, or use the knowledge base chunking settings.',
      INGESTION_CORE_TOOL_FAILED: 'Core ingestion tool failed',
      INGESTION_CORE_TOOL_FAILED_SUGGESTION: 'Review the raw error and application logs, fix the tool dependency, and retry smart analysis.',
      ...
      INGESTION_TOOL_FAILED: 'Ingestion tool failed',
      INGESTION_TOOL_FAILED_SUGGESTION: 'Review the reported failure category and application logs, fix the tool failure, and retry.',
      INGESTION_TOOL_ARGUMENTS_INVALID: 'Invalid ingestion tool arguments',
      INGESTION_TOOL_ARGUMENTS_INVALID_SUGGESTION: 'Review the reported field and constraint, then retry with a compatible tool-calling model.',
      INGESTION_CANDIDATE_PREVIEW_FAILED: 'Chunking preview validation failed',
      INGESTION_CANDIDATE_PREVIEW_FAILED_SUGGESTION: 'The production chunker failed a position, ordering, or parent-child invariant. Review the reported constraint and application logs.',
      INGESTION_CANDIDATE_LIMIT_REACHED: 'Chunking candidate limit reached',
      INGESTION_CANDIDATE_LIMIT_REACHED_SUGGESTION: 'The Agent continued previewing after reaching the candidate limit. Retry so it can submit an existing valid candidate.',
      INGESTION_DECISION_INVALID: 'Invalid ingestion decision',
      INGESTION_DECISION_INVALID_SUGGESTION: 'The submitted candidate was not successfully previewed or validated. Retry or use the knowledge base chunking settings.',
      ...
      INGESTION_AGENT_EXECUTION_FAILED_SUGGESTION: 'Review the raw error and application logs, fix the model or tool service, and retry.',
  ...
  model: {
    ...
    editor: {
      ...
      contextWindowTokensDetected: 'Automatically set to {value} tokens from the provider and model name; override it for your deployment limit.',
  ...
  integrations: {
    ...
    api: {
      ...
      personalTitle: 'Personal API integration',
      personalSubtitle: 'Use your own key to retrieve authorized knowledge bases and chat, without model, member, or workspace management access.',
      myApiKeys: 'My API keys',
      personalKeysHint: 'Personal keys are fixed to retrieve and chat and can access only the knowledge bases selected at creation.',
      personalFixedCapabilities: 'Retrieve + chat',
      personalOwner: 'Member',
      personalExamples: 'Request examples',
      personalExamplesHint: 'Examples use your first key and authorized knowledge base. Copy them and replace the question.',
      personalHistory: 'Personal API history',
      personalHistoryHint: 'Only sessions created by your personal API keys appear here. Web chat and other members are excluded.',
      personalHistorySearch: 'Search session titles',
      personalHistoryEmpty: 'No personal API sessions yet',
      personalHistorySelect: 'Select a session to read its messages',
      personalHistoryLoadFailed: 'Failed to load personal API sessions',
      personalHistoryLoadMore: 'Load more messages',
      personalMessagesEmpty: 'This session has no messages',
      personalUntitledSession: 'Untitled session',
      personalRoleUser: 'User',
      personalRoleAssistant: 'Assistant',
      personalKnowledgeRequired: 'Select at least one readable knowledge base',
      personalKnowledgeLoadFailed: 'Failed to load available knowledge bases',
      personalKnowledgeHint: 'The key will not automatically gain access to future knowledge bases. Create or authorize a key explicitly when needed.',
      personalCreateRequired: 'Enter a name and select at least one knowledge base',
      personalTokenCreated: 'Personal API key created',
      personalTokenCreatedHint: 'Copy and store this key securely now.',
      apiKeys: 'API Keys',

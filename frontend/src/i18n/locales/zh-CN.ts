export default {
  ...
  datasource: {
    ...
    noResourcesDesc_wecom_wedrive: "请确认已填写企业微信微盘 space id，并在管理后台为自建应用开通微盘 API 权限",
    ...
    connectorDesc: {
      ...
      wecom_wedrive: "浏览企业微信内置微盘空间、文件夹和文件",
    },
    field: {
      appId: "App ID",
    ...
    prereqBarText_wecom_wedrive: "首次使用？点击查看企业微信微盘 API 配置指引",
    ...
    prereqStep1Brief_wecom_wedrive: "创建或选择企业微信自建应用",
    prereqStep1Desc_wecom_wedrive: "企业微信管理后台 → 应用管理 → 创建自建应用，并记录企业 ID 与应用 Secret",
    prereqStep2Brief_wecom_wedrive: "开通微盘 API 权限",
    prereqStep2Desc_wecom_wedrive: "企业微信管理后台 → 协作 → 微盘 → API，配置可调用的自建应用，并确认操作者 userid 对目标空间有读取权限",
    prereqStep3Brief_wecom_wedrive: "填写目标微盘 Space ID",
    prereqStep3Desc_wecom_wedrive: "第一版不会全企业枚举空间，需要管理员填写部门公共微盘空间 ID 后再浏览文件夹",
    prereqOpenConsole_wecom_wedrive: "前往企业微信微盘管理",

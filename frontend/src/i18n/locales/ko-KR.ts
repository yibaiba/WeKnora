export default {
  ...
  integrations: {
    ...
    api: {
      ...
      personalTitle: '개인 API 통합',
      personalSubtitle: '모델, 멤버 또는 워크스페이스 관리 권한 없이 승인된 지식베이스 검색과 대화에 개인 키를 사용합니다.',
      myApiKeys: '내 API 키',
      personalKeysHint: '개인 키는 검색과 대화로 고정되며 생성 시 선택한 지식베이스에만 접근합니다.',
      personalFixedCapabilities: '검색 + 대화',
      personalOwner: '멤버',
      personalExamples: '요청 예시',
      personalExamplesHint: '첫 번째 키와 승인된 지식베이스를 사용하는 예시입니다.',
      personalHistory: '개인 API 기록',
      personalHistoryHint: '개인 API 키로 만든 세션만 표시되며 웹 채팅과 다른 멤버의 세션은 제외됩니다.',
      personalHistorySearch: '세션 제목 검색',
      personalHistoryEmpty: '개인 API 세션이 없습니다',
      personalHistorySelect: '메시지를 볼 세션을 선택하세요',
      personalHistoryLoadFailed: '개인 API 세션을 불러오지 못했습니다',
      personalHistoryLoadMore: '메시지 더 불러오기',
      personalMessagesEmpty: '이 세션에는 메시지가 없습니다',
      personalUntitledSession: '제목 없는 세션',
      personalRoleUser: '사용자',
      personalRoleAssistant: '어시스턴트',
      personalKnowledgeRequired: '읽을 수 있는 지식베이스를 하나 이상 선택하세요',
      personalKnowledgeLoadFailed: '사용 가능한 지식베이스를 불러오지 못했습니다',
      personalKnowledgeHint: '향후 추가되는 지식베이스 권한은 자동으로 부여되지 않습니다.',
      personalCreateRequired: '이름을 입력하고 지식베이스를 하나 이상 선택하세요',
      personalTokenCreated: '개인 API 키가 생성되었습니다',
      personalTokenCreatedHint: '지금 키를 복사해 안전하게 보관하세요.',
      apiKeys: 'API Keys',
  ...
  knowledgeStages: {
    ...
    errorCode: {
      ...
      INGESTION_MODEL_TOOL_CALLING_UNSUPPORTED_SUGGESTION: '네이티브 tool calling을 지원하는 요약 모델로 재시도하거나 지식베이스 청킹 설정을 사용하세요.',
      INGESTION_CORE_TOOL_FAILED: '핵심 입고 도구 실패',
      INGESTION_CORE_TOOL_FAILED_SUGGESTION: '원본 오류와 애플리케이션 로그를 확인하고 도구 의존성을 수정한 뒤 스마트 재시도하세요.',
      ...
      INGESTION_TOOL_FAILED: '입고 도구 실행 실패',
      INGESTION_TOOL_FAILED_SUGGESTION: '오류 범주와 애플리케이션 로그를 확인하고 도구 문제를 수정한 뒤 다시 시도하세요.',
      INGESTION_TOOL_ARGUMENTS_INVALID: '입고 도구 매개변수 제약 조건 위반',
      INGESTION_TOOL_ARGUMENTS_INVALID_SUGGESTION: '보고된 필드와 제약 조건을 확인한 뒤 호환되는 도구 호출 모델로 다시 시도하세요.',
      INGESTION_CANDIDATE_PREVIEW_FAILED: '청킹 미리보기 강제 검증 실패',
      INGESTION_CANDIDATE_PREVIEW_FAILED_SUGGESTION: '운영 청커의 위치, 순서 또는 부모-자식 매핑 검증이 실패했습니다. 제약 조건과 로그를 확인하세요.',
      INGESTION_CANDIDATE_LIMIT_REACHED: '청킹 후보 제한 도달',
      INGESTION_CANDIDATE_LIMIT_REACHED_SUGGESTION: 'Agent가 후보 제한에 도달한 후에도 미리보기를 계속했습니다. 기존 유효 후보를 제출하도록 다시 시도하세요.',
      INGESTION_DECISION_INVALID: '유효하지 않은 입고 결정',
      INGESTION_DECISION_INVALID_SUGGESTION: '제출된 후보가 성공적으로 미리보기 또는 검증되지 않았습니다. 재시도하거나 지식베이스 설정을 사용하세요.',
      ...
      INGESTION_AGENT_EXECUTION_FAILED_SUGGESTION: '원본 오류와 로그를 확인하고 모델 또는 도구 서비스를 수정한 뒤 재시도하세요.',
    ...
    analysis: {
      ...
      recommended: '권장',
      applied: '실제 적용',
      agentRunTitle: 'Agent 실행 추적',
      rounds: '{actual} / {max} 라운드',
      candidatesTitle: '후보 점수 비교',
      ...
      tool: {
        ...
        grep_chunks: '키워드 검색',
        list_knowledge_chunks: '지식 청크 읽기',
        query_knowledge_graph: '지식 그래프 조회',
        get_document_info: '문서 정보 읽기',
        database_query: '읽기 전용 데이터베이스 조회',
        data_analysis: '데이터 분석',
        data_schema: '데이터 스키마 읽기',
        web_search: '웹 검색',
        web_fetch: '웹 페이지 가져오기',
        wiki_read_page: 'Wiki 페이지 읽기',
        wiki_search: 'Wiki 검색',
        wiki_read_source_doc: 'Wiki 원본 읽기',
        wiki_read_issue: 'Wiki issue 읽기'
      },
      documentKind: {
  ...
  uploadConfirm: {
    ...
    navChunkingSmart: 'Agent가 결정',
    processingModeLabel: '청킹 처리 방식',
    processingModeDescription: '스마트 분석이 파일별 문서 특성을 파악해 청킹 매개변수를 선택합니다.',
    modeSmart: '스마트 분석',
    modeKnowledgeBase: '지식베이스 설정',
    smartDecisionHint: '전략, 청크 크기, 겹침, 부모-자식 청킹, 구분자는 Agent가 결정합니다.',
    smartModelMissing: '이 지식베이스에 요약 모델이 없습니다. 스마트 분석은 명시적으로 실패하므로 모델을 설정하거나 지식베이스 설정을 사용하세요.',
    smartUrlsUseKb: '이 배치의 URL에는 스마트 분석이 적용되지 않으며 지식베이스 설정을 사용합니다.',
    smartWebAccess: '웹 검색 및 가져오기 허용',
    smartWebAccessDescription: '활성화하면 Agent가 쿼리 또는 선택한 원문 일부를 설정된 외부 Web 서비스로 전송할 수 있습니다.',
    smartMcpAccess: '읽기 전용 MCP 도구 허용',
    smartMcpAccessDescription: '활성화하면 Agent가 readOnlyHint=true를 선언한 MCP 도구로 쿼리 또는 원문 일부를 전송할 수 있으며, 백그라운드 처리는 대화형 인증을 기다리지 않습니다.',
    agentOwned: 'Agent가 결정',
    statusOn: '켜짐',
    statusOff: '꺼짐',
    notSet: '미설정',
    summaryNoTags: '미설정',
